...
/**
 * The "Encode/Decode/Hash..." right-click menu item. Clicking it opens the Encode/Decode/Hash
 * dialog with the selected text pre-filled.
 */
...
public class PopupEncoderMenu extends ExtensionPopupMenuItem {
    ...
    public PopupEncoderMenu(Runnable dialogAction) {
        ...
        addActionListener(e -> dialogAction.run());
    }
